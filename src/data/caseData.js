...
export const FINAL_SLOTS = [
  {
    ...
    weights: { whois: 1, registry: 1, html_author: 1, nightwatch: 0.5, draft: 0.5, shield: 0.5, domain_tweet: 0.25 },
    reactions: {
  ...
  },
  {
    ...
    weights: { flickr_gps: 1, courier: 1, same_room: 0.75, table_sign: 0.75, building_owner: 0.25 },
    reactions: {
  ...
  },
  {
    ...
    weights: { court: 1, sealed: 0.75, insider: 0.75, key_wifi: 0.5, draft: 0.5, deleted: 0.25 },
    reactions: {
